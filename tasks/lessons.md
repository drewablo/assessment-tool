...
- When the next roadmap wave is blocked by new components or net-new data sources, pair the unblocked UI slice with a concrete readiness doc/checklist so progress is actionable instead of speculative.
